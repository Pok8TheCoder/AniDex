...
from localfun.db.schema import ANIME_STATUSES
...
class AnimeLibrary(QWidget):
    ...
    def __init__(self, repo: Repository) -> None:
        ...
        tip = QLabel(
            "Paste an AnimePahe play URL. LocalFun reads the anime + episode from "
    ...
    def on_download_done(self, result) -> None:
        from localfun.services.anime_download import DownloadResult

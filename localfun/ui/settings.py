...
from localfun.paths import app_data_dir, db_path, tokens_path
from localfun.services.mal_api import MalApiError, MalClient
from localfun.services.sync import (
    export_repo_to_xml,
...
class SettingsView(QWidget):
    ...
    def backup_db(self) -> None:
        path, _ = QFileDialog.getSaveFileName(
            self, "Backup database", "localfun-backup.db", "SQLite (*.db)"
        )
        if not path:
            return

...
from anidex.web.api import router as api_router
from anidex.web.api_sync import router as sync_router
from anidex.web.jobs import JOBS
from anidex.web.security import LocalAccessMiddleware, sync_lan_from_env
...
async def lifespan(_app: FastAPI):
    sync_lan_from_env()
    init_db()
    from anidex.web.auth import ensure_auth_defaults

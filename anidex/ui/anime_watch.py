...
from anidex.db.repositories import AnimeEntry, LocalMediaEntry, Repository
...
class PaheLinkWorker(QThread):
    ...
    def run(self) -> None:
        try:
            from anidex.services.pahe_catalog import (
                link_anime_to_pahe,
...
class StreamResolveWorker(QThread):
    ...
    def run(self) -> None:
        try:
            ...
            from anidex.services.hls_proxy import start_hls_proxy

...
from anidex.services.mal_xml import export_mal_xml, parse_mal_xml
...
def export_repo_to_xml(repo: Repository, path: str) -> str:
    ...
    export_mal_xml(entries, username=profile.mal_username or profile.display_name or "AniDex", path=path)
    return path
